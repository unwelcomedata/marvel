"""Generate notebooks/02-clean.ipynb for the marvel project."""
...
# Step 4: cross-check against BOM
cells.append(new_markdown_cell(
...
nbf.write(nb, 'notebooks/02-clean.ipynb')
print('wrote notebooks/02-clean.ipynb')
